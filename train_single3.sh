...
# CUDA_VISIBLE_DEVICES=5 python -m torch.distributed.launch --nproc_per_node=1 main_single.py --percent 0.3 --model_path "checkpoint/ViTSingle-rm3-h16-LD2-frr16-cspdarknet53" --log_name "simclr-single-rm3-h16-LD2-frr16-cspdarknet53" --epoch_num 89
CUDA_VISIBLE_DEVICES=5 python -m torch.distributed.launch --nproc_per_node=1 main_single.py --percent 0.4 --model_path "checkpoint/ViTSingle-rm4-h16-LD2-frr16-cspdarknet53" --log_name "simclr-single-rm4-h16-LD2-frr16-cspdarknet53" --epoch_num 9
